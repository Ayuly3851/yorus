# import nsupkg/nsu_types, nsupkg/nsu_win32

# proc screenshot(filename = "8bda3.png", savePath:string = ".", delay:int = 0): string =
#     result = nsu_take_ss(FULL, fileName, savePath, delay)

# let resFile = screenshot()
